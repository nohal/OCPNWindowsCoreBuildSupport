...
LangString LangDialog_Title ${LANG_FRENCH} "OpenCPN 5.7.1 Installation"
...
LangString Uninstall_Link ${LANG_FRENCH} "Désinstalle  OpenCPN 5.7.1"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_FRENCH} "OpenCPN 5.7.1 est déjà installé.$\r$\nChoisir comment vous voulez installer OpenCPN."
...
LangString Finish_Link_URL ${LANG_FRENCH} "http://opencpn.info/?ref=installer&utilisateurr=$USERS_NAME&lang=$REG_LANG&version=5.7.1"
...
LangString ^NameDA ${LANG_FRENCH} "OpenCPN Version 5.7.1"
