...
LangString LangDialog_Title ${LANG_GERMAN} "OpenCPN 5.7.1 Installation"
...
LangString Uninstall_Link ${LANG_GERMAN} "OpenCPN 5.7.1 deinstallieren"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_GERMAN} "OpenCPN 5.7.1 ist bereits installiert.$\r$\nWählen Sie aus, wie Sie OpenCPN installieren möchten."	
...
LangString Finish_Link_URL ${LANG_GERMAN} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=5.7.1"
...
LangString ^NameDA ${LANG_GERMAN} "OpenCPN Version 5.7.1"
